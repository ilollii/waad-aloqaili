...
# Load spotlight scraped data
with open(r'C:\Users\o3v7g\.gemini\antigravity-ide\scratch\1886-riyadh-fashion\spotlight_data.json', 'r', encoding='utf-8') as f:
    spotlight_data = json.load(f)

# Events data structured with real text and photos
events = [
    {
        "title_en": "THE 6TH EDITION OF THE JOY AWARDS (2026)",
        "title_ar": "الدورة السادسة لحفل جوائز صنّاع الترفيه (Joy Awards 2026)",
        "date": "January 2026",
        "desc_en": "Waad Aloqaili Couture adorned celebrated international and Arab figures in bespoke handcrafted gowns, blending modern royal silhouettes with intricate crystal embellishments.",
        "desc_ar": "تألقت نجمات الفن والمشاهير بإبداعات دار وعد العقيلي على السجادة اللافندرية لحفل جوائز Joy Awards، في تصاميم كوتور خاصة عكست الفخامة الملكية والتطريز اليدوي الدقيق.",
    ...
    },
    {
        ...
        "date": "December 2025",
        "desc_en": "For the 5th Red Sea Film Festival in historic Jeddah, Waad Aloqaili Couture presented standout creations celebrating maritime heritage, rich silk taffeta, and oceanic elegance.",
        "desc_ar": "في قلب جدة التاريخية، قدمت دار وعد العقيلي إطلالات استثنائية على السجادة الحمراء استلهمت سحر البحر الأحمر وعراقة التراث السعودي بأقمشة التافتا والحرير الإيطالي الفاخر.",
    ...
    },
    {
        ...
        "date": "October 2025",
        "desc_en": "A breathtaking runway showcase by Waad Aloqaili featuring the Spring/Summer 2026 Yamal couture collection, paying homage to Saudi Arabia's pearl diving heritage.",
        "desc_ar": "عرض أزياء ساحر خطف أنظار الصحافة العالمية في أسبوع الموضة بالرياض، مستعرضاً مجموعة 'يمال' لربيع وصيف 2026 المستوحاة من تراث الغوص واللؤلؤ السعودي.",
        "img": "https://waadaloqaili.com/cdn/shop/files/Photo_19-02-2026_11_56_31_AM_4_1.jpg?width=1800"
    },
    {
        "title_en": "THE 78TH EDITION OF THE CANNES FILM FESTIVAL",
        "title_ar": "الدورة الـ 78 لمهرجان كان السينمائي الدولي",
        "date": "May 2025",
        "desc_en": "At the 78th Annual Cannes Film Festival, Waad Aloqaili Couture unveiled exquisite creations reflecting the house's refined mastery on the world's most watched red carpet.",
        "desc_ar": "على السجادة الحمراء لقصر المهرجانات في كان، أبهرت تصاميم وعد العقيلي عدسات الإعلام الدولي بحرفيتها الاستثنائية وتطريزها الملكي المتفرد.",
        "img": "https://waadaloqaili.com/cdn/shop/files/Photo_21-05-2025_10_41_54_AM.jpg?width=1800"
    },
    {
        "title_en": "HARPER'S BAZAAR ARABIA – DECEMBER ISSUE",
        "title_ar": "مجلة هاربرز بازار – غلاف وإصدار ديسمبر",
        "date": "December 2024",
        "desc_en": "A dedicated editorial tribute celebrating the artisanal craftsmanship, empowerment, and visionary haute couture architecture of designer Waad Aloqaili.",
        "desc_ar": "جلسة تصوير تحريرية واحتفاء خاص بفلسفة الدار وحرفيتها اليدوية في تمكين المرأة وصياغة لغة جديدة للهوت كوتور السعودي.",
        "img": "https://waadaloqaili.com/cdn/shop/files/harpersbazaararabia.jpg?width=1800"
    },
    {
        "title_en": "VOGUE ARABIA – SEPTEMBER COVER & EDITORIAL",
        "title_ar": "مجلة فوغ العربية – غلاف سبتمبر مع كانديس سوانبويل",
        "date": "September 2024",
        "desc_en": "Supermodel and ocean advocate Candice Swanepoel draped in a bespoke Waad Aloqaili oceanic couture gown celebrating the enchanting depths of the Red Sea.",
        "desc_ar": "عارضة الأزياء العالمية كانديس سوانبويل تتألق بفستان كوتور خاص من تصميم وعد العقيلي مستوحى من أعماق البحر الأحمر في جلسة تصوير عالمية لفوغ.",
    ...
    },
    {
        ...
        "date": "November 2024",
        "desc_en": "Ruba Tursun captivated the Billboard Arabia red carpet in Waad Aloqaili Couture SS25 'Veil of Renewal', showcasing sculptural silhouettes and delicate hand embroidery.",
        "desc_ar": "إطلالة أيقونية لـ ربا طرسون على سجادة بيلبورد عربية بفستان كوتور استثنائي من مجموعة 'حجاب التجدد' عكس رشاقة القوام ودقة التطريز الكريستالي.",
        "img": "https://waadaloqaili.com/cdn/shop/files/Photo_30-09-2024_1_00_03_PM_1.jpg?width=1800"
    },
    {
        "title_en": "THE 77TH ANNUAL CANNES FILM FESTIVAL",
        "title_ar": "الدورة الـ 77 لمهرجان كان السينمائي الدولي",
        "date": "May 2024",
        "desc_en": "International stars illuminated the French Riviera in bespoke creations crafted exclusively in the Riyadh ateliers of Waad Aloqaili.",
        "desc_ar": "إطلالات ملكية زينت الريفييرا الفرنسية بتصاميم صُممت ونُفذت بالكامل بأيدي الحرفيين في أتيليه وعد العقيلي الرئيسي بالرياض.",
        "img": "https://waadaloqaili.com/cdn/shop/files/41E697EA-3F9F-4576-9580-4109ABAEB621.jpg?width=1800"
    },
    {
        "title_en": "HIA MAGAZINE – JUNE ISSUE WITH CARMEN SOLIMAN",
        "title_ar": "مجلة هي – غلاف شهر يونيو مع كارمن سليمان",
        "date": "June 2025",
        "desc_en": "Carmen Soliman graces the June cover of Hia Magazine celebrating Music Month in the breathtaking 'Symphony Gown' by Waad Aloqaili.",
        "desc_ar": "الفنانة كارمن سليمان تتألق على غلاف مجلة هي بفستان 'السيمفونية' الساحر من دار وعد العقيلي احتفاءً بشهر الموسيقى والفن.",
        "img": "https://waadaloqaili.com/cdn/shop/files/Photo_30-09-2024_1_00_03_PM_2.jpg?width=1800"
    },
    {
        "title_en": "THE 96TH ACADEMY AWARDS (OSCARS)",
        "title_ar": "حفل جوائز الأوسكار الـ 96 (Oscars Red Carpet)",
        "date": "March 2024",
        "desc_en": "On the prestigious red carpet of the 96th Academy Awards in Hollywood, international celebrity Ashley was draped in an exquisite bespoke gown by Waad Aloqaili.",
        "desc_ar": "حضور سعودي مبهر في هوليوود على السجادة الحمراء لحفل الأوسكار الـ 96 بإطلالة كوتور فاخرة صنعت خصيصاً للحدث العالمي.",
        "img": "https://waadaloqaili.com/cdn/shop/files/IMG_5506.jpg?width=1800"
    },
    {
        "title_en": "THE SIXTH EDITION OF THE SAUDI CUP",
        "title_ar": "كأس السعودية للخيل – الدورة السادسة (عام الحرف اليدوية)",
        "date": "February 2025",
        "desc_en": "Celebrating Saudi Arabia's Year of Handicrafts, an iconic ensemble mirroring cultural heritage, fine bisht embroidery, and timeless royal majesty.",
        "desc_ar": "احتفاءً بعام الحرف اليدوية، تألقت إطلالات كأس السعودية بأزياء جسدت تطريز القصب والزري التراثي برؤية كوتور معاصرة.",
    ...
    {
        "title_en": "THE 80TH VENICE INTERNATIONAL FILM FESTIVAL",
        "title_ar": "الدورة الـ 80 لمهرجان البندقية السينمائي (Venice Film Festival)",
        "date": "September 2023",
        "desc_en": "The Venice red carpet bore witness to the mesmerizing enchantment of Waad Aloqaili Couture, celebrated for timeless elegance and Italian silk artistry.",
        "desc_ar": "حضور ساحر على السجادة الحمراء لجزيرة الليدو بالبندقية في تصاميم هوت كوتور نالت إشادة واسعة من نقاد الموضة العالميين.",
    ...
    },
    {
        ...
        "date": "May 2023",
        "desc_en": "Spectacular red-carpet moments featuring hand-beaded crystalline capes and architectural draping by designer Waad Aloqaili.",
        "desc_ar": "لحظات لا تُنسى في مهرجان كان السينمائي بتصاميم الكاب الكريستالي والدرابيه الهندسي المتقن.",
    ...
    },
    {
        ...
        "date": "May 2022",
        "desc_en": "Waad Aloqaili Couture House made a stunning impact at the star-studded 75th Annual Cannes Film Festival, marking a milestone for Saudi high fashion.",
        "desc_ar": "البداية التاريخية لتألق الدار على السجادة الحمراء لمهرجان كان الـ 75 كواحدة من أوائل دور الأزياء السعودية الراقية المشاركة عالمياً.",
        "img": "https://waadaloqaili.com/cdn/shop/files/D78F1FE0-8B3E-4A54-9325-F6FBA5694E70_4.jpg?width=1800"
    }
]

# Generate Editorial Event Cards HTML
events_cards_html = []
for idx, ev in enumerate(events):
    card = f'''
    <article class="spotlight-story-card scroll-reveal">
      <div class="spotlight-img-wrap">
        <img src="{ev['img']}" alt="{ev['title_en']}" class="spotlight-main-img" loading="lazy">
        <span class="spotlight-date-badge">{ev['date']}</span>
      </div>
      <div class="spotlight-story-content">
        <span class="spotlight-category-tag">RED CARPET & PRESS</span>
        <h3 class="spotlight-story-title">
          <span class="txt-en">{ev['title_en']}</span>
          <span class="txt-ar">{ev['title_ar']}</span>
        </h3>
        <p class="spotlight-story-desc">
          <span class="txt-en">{ev['desc_en']}</span>
          <span class="txt-ar">{ev['desc_ar']}</span>
        </p>
    ...
    '''
    events_cards_html.append(card)

all_events_str = '\n'.join(events_cards_html)

spotlight_page_html = f'''<!DOCTYPE html>
...
<body data-lang="ar">
  ...
  <section class="spotlight-hero-header">
    ...
    <div style="display:flex; justify-content:center; gap:1.2rem; flex-wrap:wrap;">
      ...
      <button class="btn-secondary" onclick="window.app.openBookingModal()" style="background:rgba(255,255,255,0.15); color:#FFF; border-color:rgba(255,255,255,0.4); padding:1rem 2rem; backdrop-filter:blur(8px);">
        <span class="txt-ar">حجز موعد قياس كوتور خاص</span>
        <span class="txt-en">Book Private Fitting</span>
      </button>
    </div>
  </section>

  <!-- Spotlight Articles & Events Grid -->
      ...
      <ul class="drawer-nav-list">
        <li class="drawer-nav-item">
          <a href="collections.html" class="drawer-nav-link">
            <span>
              <span class="txt-ar">صفحة جميع الفساتين (106 فساتين)</span>
              <span class="txt-en">All Boutique Gowns Page (106)</span>
            </span>
            <span class="drawer-nav-badge">106</span>
          </a>
        </li>
        <li class="drawer-nav-item">
        ...
        <li class="drawer-nav-item">
          <a href="collections.html?cat=elan-vital" class="drawer-nav-link">
            <span>
        ...
        <li class="drawer-nav-item">
          <a href="collections.html?cat=celestia" class="drawer-nav-link">
            <span>
        ...
        <li class="drawer-nav-item">
          <a href="collections.html?cat=bridal" class="drawer-nav-link">
            <span>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {{
      ...
      if (cursor && window.innerWidth > 900) {{
        ...
        document.querySelectorAll('a, button, .spotlight-story-card').forEach(el => {{
...
with open(r'C:\Users\o3v7g\.gemini\antigravity-ide\scratch\1886-riyadh-fashion\under-the-spotlight.html', 'w', encoding='utf-8') as f:
    f.write(spotlight_page_html)

print("Generated under-the-spotlight.html successfully with all 14 authentic red-carpet and press events!")
